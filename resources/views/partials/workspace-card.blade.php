    ...
    <div class="bg-[#0f0f14] border border-white/[0.08] rounded-3xl w-full max-w-lg shadow-2xl overflow-y-auto max-h-[90vh]"
        ...
        <form action="{{ route('orders.report', $order) }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="flex items-start gap-3 px-4 py-3 bg-indigo-500/[0.08] border border-indigo-500/[0.14] rounded-2xl">
                ...
                <div class="space-y-1">
                    <p class="text-[11px] text-indigo-100 font-semibold leading-relaxed">Upload the required result PDFs to complete this order.</p>
                    <p class="text-[10px] text-indigo-200/70 leading-relaxed">AI report plus plagiarism report are expected. If the AI report cannot be generated, use the fallback option below.</p>
                </div>
            </div>
            ...
            <div class="flex flex-col gap-3 rounded-2xl border border-amber-500/[0.16] bg-amber-500/[0.06] px-4 py-3">
                <div class="flex items-start gap-3">
                    ...
                    <div class="space-y-1 min-w-0">
                        ...
                        <p class="text-[10px] text-amber-200/70 leading-relaxed">Use this only when the AI tool cannot generate a valid PDF.</p>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <div id="ai-upload-container-{{ $order->id }}" class="space-y-2">
                    <label class="flex items-center justify-between gap-1.5 text-[9px] font-bold text-slate-400 uppercase tracking-widest">
                        <span class="flex items-center gap-1.5"><span class="w-1.5 h-1.5 rounded-full bg-red-400"></span>AI Detection Report</span>
                ...
                <div class="space-y-2">
                    <label class="flex items-center justify-between gap-1.5 text-[9px] font-bold text-slate-400 uppercase tracking-widest">
                        <span class="flex items-center gap-1.5"><span class="w-1.5 h-1.5 rounded-full bg-amber-400"></span>Plagiarism Report</span>
